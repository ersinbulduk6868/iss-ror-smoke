    ...
    def decide(
        ...
        *,
        ...
        if phase == "COUNTERATTACK" or story == "COUNTER":
            ...
            return TacticalGoal(
                "COUNTER", memory.reason, "ACCELERATE", clamp(base_scale * 0.90 * damage_retry_scale, 0.30, 1.0),
        ...
        return TacticalGoal(
            "ENGAGE", memory.reason, "ACCELERATE", clamp(base_scale * damage_retry_scale, 0.25, 1.0),
