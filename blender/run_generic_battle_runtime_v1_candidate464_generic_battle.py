...
MECHANISM = "ISS_GENERIC_AUTONOMOUS_BATTLE_MECHANISM_V6"
AUDIT = "SOLVER_HANDOFF_LATCH_AFFECTED_LAYER_AUDIT_20260918"
...
def main() -> None:
    ...
    print(
        json.dumps(
            {
                "marker": "GENERIC_AUTONOMOUS_BATTLE_C464_ENGINEERING_READY",
                "candidate": CANDIDATE,
                "mechanism": MECHANISM,
