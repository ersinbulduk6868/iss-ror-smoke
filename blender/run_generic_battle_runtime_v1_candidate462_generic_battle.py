...
from blender import iss_battle_runtime_generic_battle_v4 as battle_v4
...
from blender.iss_battle_runtime_tactics_v4 import BATTLE_SIGNAL_SCOPE, TACTICAL_MODEL

CANDIDATE = "ISS_GENERIC_BATTLE_RUNTIME_V1_CANDIDATE_4_6_2_GENERIC_AUTONOMOUS_BATTLE"
MECHANISM = "ISS_GENERIC_AUTONOMOUS_BATTLE_MECHANISM_V4"
...
def generic_battle_g06_outcome(states: dict[str, Any], events: dict[str, Any]) -> dict[str, Any]:
    ...
    battle_v4.write_evidence(Path(hardened._capture_output))
    return outcome
...
def main() -> None:
    ...
    print(
        json.dumps(
            {
                "marker": "GENERIC_AUTONOMOUS_BATTLE_C462_ENGINEERING_READY",
                "candidate": CANDIDATE,
                "mechanism": MECHANISM,
                "fullAffectedLayerAudit": AUDIT,
                "tacticalModel": TACTICAL_MODEL,
                "battleControlModel": battle_v4.BATTLE_CONTROL_MODEL,
