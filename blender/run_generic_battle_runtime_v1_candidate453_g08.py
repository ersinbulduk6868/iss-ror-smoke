...
def _is_valid_vertical_9x16(width: int, height: int) -> bool:
    return bool(width > 0 and height > width and abs((float(width) / float(height)) - (9.0 / 16.0)) <= 0.01)
...
def main() -> None:
    ...
    print(json.dumps({
        "marker": "GENERIC_BATTLE_RUNTIME_CANDIDATE453_G08_ENGINEERING_PASS",
        "candidate": CANDIDATE,
        ...
        "climaxRelationshipAnchor": True,
        "payoffFocusFromRealizedDominance": True,
