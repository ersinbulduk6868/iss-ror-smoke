...
AUDIT = "G04_MASTER_PLAN_HETEROGENEOUS_ACTORPROFILE_L4_ACCEPTANCE_20260918"


def main() -> None:
    print(json.dumps({
        "marker": "GENERIC_AUTONOMOUS_BATTLE_C477_ENGINEERING_READY",
        "candidate": CANDIDATE,
        "mechanism": MECHANISM,
        ...
        "lightActorProfile": "GENERIC_HYPERCAR_V1",
        "heavyActorProfile": "PRODUCTION_BULLDOZER_ASSET_DERIVED",
