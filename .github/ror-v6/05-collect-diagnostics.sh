#!/usr/bin/env bash
set +e
mkdir -p artifacts/logs artifacts/logs/stall-diagnostics
...
find artifacts/logs/stall-diagnostics -maxdepth 3 -type f -print | sort > artifacts/logs/stall-diagnostics-manifest.txt 2>&1 || true
true
